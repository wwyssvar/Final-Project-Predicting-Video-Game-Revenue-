...
# Boxplot of revenue by number of players
ggplot(gaming_clean, aes(x = factor(Players_Millions), y = Revenue_Millions)) +
  geom_boxplot() +
  labs(
    title = "Revenue by Number of Players",
    x = "Players (Millions)",
    y = "Revenue (Millions of Dollars)"
  )
...
* Release and Number of Players did not guarantee high revenue. The trend line was flat.
* Critical Scores and Esports Popularity had weak to moderate corelations.
